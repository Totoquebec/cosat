...
class PDF_HTML extends MEM_IMAGE
{
	...
	function Header()
	{
		global $fich_fond,$x_fond,$y_fond,$w_fond,$h_fond;
	   ...
	   /* $this->SetFont('Arial','B',5);
	    ...
	    //Saut de ligne
	    $this->Ln(10);*/
		if( isset($fich_fond) && ($this->PageNo() > 1) ) 
	        	$this->Image($fich_fond,$x_fond,$y_fond,$w_fond,$h_fond, 'JPEG');
	}
