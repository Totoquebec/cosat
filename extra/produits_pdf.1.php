...
//			echo 'Avant : '.$description2.'<br/>';
	...
	$html .= "<p align=center>$LeTitre</p><br/>";
...
function toto( $id, $ref )
{
global $handle, $mysql_base, $LaPhoto , $pdf;
		if ($id == "")
...
//			$pdf->Image('var://LaPhoto', 180,$pdf->GetY(),20,20,'JPEG');
			$pdf->Image($target, 180,$pdf->GetY(),20,20,'JPEG');
	   }
...
{
//NOS VARIALBE GLOBAL
global $larg,$html, $pdf, $prod_filter, $mysql_base, $handle, $point_par_ligne,$top_marge, $police_point,
