...
?>
<table bgcolor='#f0f1f3' width='<?=$Large?>' align='<?=$Enligne?>' cellpadding='0' cellspacing='0' border='1'  >
	<tr>
...
?>
	...
	<tr>
		<td align='center' ><!--680 x 510 -->
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" 
				codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="600" height="250" id="carrousel" align="middle" border='1'>
			<param name="allowScriptAccess" value="sameDomain" />
			<param name=FlashVars value="speed1=0.01" />
			<param name="movie" value="carrousel.swf?speed1=0.01" />
			<param name="quality" value="high" />
			<!-- param name="wmode" value="transparent" / -->
			<param name="bgcolor" value="#ffffff" />
			<embed src="carrousel.swf?speed1=0.01" quality="high" wmode="transparent" bgcolor="#ffffff" width="680" height="450" 
				name="carrousel" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" 
