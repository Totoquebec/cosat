...
* Description : Gestion des achats qui dépasse la limite permise
...
//*************************************************************************************************
$message = "
			<b><big>***** COMPRA EN ESPERA DE PAGO *****</big></b><br><br>
			Hola,<br><br>
...
<table bgcolor='#FFFFFF' width='$Large' cellpadding='4' cellspacing='4' border='1' align='$Enligne' >
	<tr>
		<td colspan='2'>
			<div align=center>";
	echo sprintf( $txt['msg_probleme'], $_SESSION['OrderId'], $_SESSION['Totaux']['totalpourbanque'] );
	echo "<br><br>";
	echo "
