...
$produit = get_prod_infos_by_id($_GET['id']);
		...
		calcul_format_photo( $LargX, $HautY, $produit['id'], $produit['big'] );
...
//	var imagenStr = '<img id="zoomimg" src=<?php echo "photoget_web.php?No=".$produit['id']."&Idx=".$produit['big']; ?> width=100% height=100% />';
	var imagenStr = '<img id="zoomimg" src=<?php echo "photo/".$produit['id']."/".$produit['big']; ?> width=100% height=100% />';
...
<div id="control">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td>
<a href="javascript:zoomIn(true)"><img src="gifs/agrandir_<?=$_SESSION['langue']?>.gif" alt="" border="0" /></a> &nbsp;
<a href="javascript:zoomOut(true)"><img src="gifs/reduire_<?=$_SESSION['langue']?>.gif" alt="" border="0" /></a> &nbsp;
<a href="javascript:zoomDef(false)"><img src="gifs/vuenormal_<?=$_SESSION['langue']?>.gif" alt="" border="0" /></a>
            </td>
        </tr>
    </table>
